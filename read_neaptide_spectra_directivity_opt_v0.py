...
measured_SPL = np.array(
    [
        compute_spl_from_wav(wav)
        for wav in wav_files
    ]
)
...
A_fit, a1_fit, a2_fit, a3_fit = popt

print("Fitted source level:", A_fit)
print("Coefficients:", a1_fit, a2_fit, a3_fit)

SPL_fit = harmonic_directivity(
    theta_rad,
    A_fit,
    a1_fit,
    a2_fit,
