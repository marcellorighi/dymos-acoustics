...
phase = dm.Phase(ode_class=DroneODE, 
                 ...
                 transcription=dm.GaussLobatto(num_segments=18, order=3))
...
phase.add_state('z', fix_initial=True, lower = 0, upper = 70., ref=5.0, fix_final=True, rate_source=f'z_dot')
...
for a in ['ax', 'ay', 'az']:
    phase.add_control(a, lower=-12.0, upper=12.0, rate_continuity=True, 
