...
import numpy as np
from drone_pid_function_v12 import evaluate_drone_codesign
from drone_pid_function_v12 import plot_comprehensive_diagnostics
...
if __name__ == "__main__":
    ...
    prob.set_val('R_rotor', 0.19)   
    prob.set_val('L_arm',   0.27)   
    prob.set_val('v_max',   5.69)    
    prob.set_val('t_climb', 1.89)    
    prob.set_val('vx_max',  3.0)     # Initial forward speed suggestion (e.g. 3m/s)
