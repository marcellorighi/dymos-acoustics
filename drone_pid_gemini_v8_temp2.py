...
if __name__ == "__main__":
    ...
    print("Running a single baseline test without a try/except net...")

    # Use the exact configuration that worked earlier
    test_gains = [0.05, 0.01, 2.5, 0.4, 15.0, 10.0]

    # Run it wide open so it crashes on your terminal screen
    outputs = run_drone_acoustic_simulation(
        test_gains, dryden_ts, velocity_schedule, time_steps, dt
    )

    print("If you see this line, it worked!")
