...
p.driver.opt_settings['max_iter'] = 80
...
## or, to override assumptions:
#params = DroneParams(mass=2.0, arm_length=0.3, rpm_hover=4500, z_up=True)
#result = estimate_rotor_rpm(t, x, y, z, vx, vy, vz, ax, ay, az, wx, wy, wz, params=params)

#t_out         = result["t"]
#rpm_front     = result["rpm_front"]
#rpm_rear      = result["rpm_rear"]
#rpm_right     = result["rpm_right"]
#rpm_left      = result["rpm_left"]

#fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(12, 5))

#ax1.plot(t_out, rpm_front, label = "Front")   
#ax1.plot(t_out, rpm_right, label = "Right")   
#ax1.plot(t_out, rpm_rear, label = "Rear")   
#ax1.plot(t_out, rpm_left, label = "Left")   
