...
from drone_acoustic_radiation_v5 import (
        calibrate_p_ref, AcousticParams, FineGridParams, load_directivity_model,
...
def plot_acoustic_spectrum(spectrum_data, max_freq_display=5000.0):
    """
...
if __name__ == "__main__":
    ...
    plot_acoustic_spectrum(spectrum, max_freq_display=5000.0)
